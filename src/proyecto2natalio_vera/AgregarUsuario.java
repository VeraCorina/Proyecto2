...
public class AgregarUsuario extends javax.swing.JFrame {
     ...
     */
    public AgregarUsuario(Impresora i) {
        initComponents();
        this.setVisible(true);
        impresora = i;
        this.grafo.setText(impresora.mostrarListaUsuariosPrioridad());
    }
    ...
    private void initComponents() {
        ...
        pan.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, -1, -1));
        ...
        prioridad.setBackground(new java.awt.Color(153, 153, 153));
        prioridad.setFont(new java.awt.Font("Verdana", 2, 24)); // NOI18N
        prioridad.setForeground(new java.awt.Color(255, 255, 255));
        pan.add(prioridad, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 350, 290, -1));

        jLabel7.setFont(new java.awt.Font("Verdana", 3, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Prioridad (Alta, Media o Baja):");
        pan.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 320, -1, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (prioridad.toLowerCase().trim().equals("alta")) {
            prioridad = "prioridad_alta";
        } else if (prioridad.toLowerCase().trim().equals("media")) {
            prioridad = "prioridad_media";
        } else if (prioridad.toLowerCase().trim().equals("baja")) {
            prioridad = "prioridad_baja";
        } else {
            JOptionPane.showMessageDialog(rootPane, "Escribe una prioridad valida");
            return;
        }
        impresora.agregarUsuario(name, prioridad);
        this.nombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AgregarUsuario(impresora).setVisible(true));
    }
