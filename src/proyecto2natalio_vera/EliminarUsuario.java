...
public class EliminarUsuario extends javax.swing.JFrame {
     ...
     */
    public EliminarUsuario(Impresora i) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pan.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 290, -1, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        impresora.eliminarUsuario(name);
        this.nombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new EliminarUsuario(impresora).setVisible(true));
    }
